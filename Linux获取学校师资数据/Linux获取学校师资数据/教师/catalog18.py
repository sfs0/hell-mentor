...
def crawl_webpage(College_website="https://sky.njfu.edu.cn/szdw/index.html"):
    try:
        headers = {
        ...
        if response.status_code == 200:
            ...
            target_td = soup.find("table", border="0", cellpadding="0", cellspacing="0", width="100%")# 查找第一个符合条件的 table
            target_links = []
            if target_td:
